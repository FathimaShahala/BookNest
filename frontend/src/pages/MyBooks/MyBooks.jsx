...
function MyBooks() {
  ...
  const nextCount = books.filter(
    (book) => book.readingStatus === "Next To Read",
  ).length;
  ...
  let filteredBooks = books.filter((book) => {
    ...
    if (activeFilter === "Favorites") {
      statusMatch = book.isFavorite;
    } else if (activeFilter !== "All") {
      statusMatch = book.readingStatus === activeFilter;
    }
      ...
      <div className="books-page">
        <div className="books-header">
          <div>
            ...
            <p>Manage, organize and track your reading collection.</p>
          </div>
        ...
        <div className="status-filters">
          ...
          <button
            className={activeFilter === "Next To Read" ? "active" : ""}
            onClick={() => setActiveFilter("Next To Read")}
          >
            ⏭ Next ({nextCount})
          </button>
